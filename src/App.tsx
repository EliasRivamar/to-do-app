          ...
          <main className="grow">
            <div className="px-4 sm:px-6 lg:px-8 py-5">
              <div className="layout-content-container flex flex-col max-w-full mx-auto">
                <h1 className="text-[#111813] dark:text-white tracking-light text-[32px] font-bold leading-tight px-4 text-center pb-3 pt-6">Dynamic Weekly To-Do Grid</h1>
                <p className="text-center text-gray-500 dark:text-gray-400 mb-10">October 21 - October 27</p>
